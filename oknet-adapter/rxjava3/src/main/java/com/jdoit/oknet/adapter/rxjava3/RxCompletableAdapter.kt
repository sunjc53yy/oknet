 ...
 * @Description:
 */
class RxCompletableAdapter<T>(var scheduler : Scheduler? = null, var isAsync : Boolean = false)
            : INetWorkerAdapter<T, Completable> {
    override fun adapter(worker: INetWorker<T>): Completable {
